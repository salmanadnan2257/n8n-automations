...
\begin{tikzpicture}[x=1cm, y=1cm]
  ...
  \node[box, text width=2.0cm] (spl) at (23.0,-1.7) {Text\\Splitter};
  \node[box, text width=2.0cm] (emb) at (25.9,-1.7) {Embeddings\\OpenAI};
  \draw[dflow] (spl.north) -- (vs.280);
  \draw[dflow] (emb.north) -- (vs.320);
  \node[lbl, anchor=north] at (24.5,-2.5) {equipment attached to the vector store};
